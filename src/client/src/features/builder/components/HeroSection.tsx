...
export function HeroSection() {
  return (
    <div className="relative pt-6 sm:pt-10 pb-4 w-full max-w-5xl">
      {/* Radiant Pill Badge */}
      ...
      <h1 className="text-4xl sm:text-6xl lg:text-[72px] font-extrabold tracking-tight text-white leading-[1.05] drop-shadow-md">
        Software begins before the <span className="text-gradient-neon">first line of code.</span>
      </h1>

      {/* Subtitle */}
      <p className="mt-4 text-base sm:text-xl text-slate-300 font-normal leading-relaxed max-w-3xl">
