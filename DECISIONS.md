...
- Added an offline AI fallback path so the end-to-end demo still works without an OpenAI API key, while preserving the real OpenAI path for production configuration.
